...
public class Drop2nd extends CommandBase {
    ...
    public void execute() {
        if (isMoving) {
            mainSubsystem.moveDrivetrain(frontLeft, rearLeft, frontRight, rearRight, variableFactory.getVariable("moveToDrop2ndPower"), variableFactory.getVariable("moveToDrop2ndDuration"));
        }
    }
